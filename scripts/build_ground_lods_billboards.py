#!/usr/bin/env python3
"""Create LOD1/LOD2/BILLBOARD for HERO ground assets."""
...
def main():
    ...
    p.add_argument("--masters-dir", default="outputs/ground/masters")
    p.add_argument("--lod-dir", default="outputs/ground/lods")
