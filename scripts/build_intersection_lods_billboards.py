#!/usr/bin/env python3
"""Create LOD1/LOD2/BILLBOARD for HERO intersection assets."""
...
def main():
    ...
    p.add_argument("--masters-dir", default="outputs/intersections/masters")
    p.add_argument("--lod-dir", default="outputs/intersections/lods")
    ...
    manifest = lod_dir.parent / "unreal_intersection_lod_manifest.csv"
    with manifest.open("w", encoding="utf-8", newline="") as f:
        w = csv.DictWriter(f, fieldnames=list(manifest_rows[0].keys()) if manifest_rows else ["intersection_key", "lod_level", "fbx_path", "triangle_ratio_target"])
        w.writeheader()
        if manifest_rows:
