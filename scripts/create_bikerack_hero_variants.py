#!/usr/bin/env python3
"""Create HERO bike rack FBX variants."""
...
def main():
    ...
    for key in hero:
        ...
        # add base plate detail
        bpy.ops.mesh.primitive_cylinder_add(vertices=20, radius=0.08, depth=0.02, location=(0, 0, 0.01))
        base = bpy.context.active_object
        bpy.ops.object.select_all(action="DESELECT")
        obj.select_set(True); base.select_set(True); bpy.context.view_layer.objects.active = obj
        bpy.ops.object.join()
        obj = bpy.context.view_layer.objects.active
