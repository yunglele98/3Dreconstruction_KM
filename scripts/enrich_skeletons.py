...
def enrich_file(filepath):
    ...
    new_lines = enriched.count("\n")
    return True, f"{orig_lines} -> {new_lines} lines"
...
def main():
    ...
    print(f"\nDone: {enriched} enriched, {skipped} skipped (of {len(files)} total)")
