#!/usr/bin/env python3
"""Create LOD1/LOD2/BILLBOARD for HERO street furniture assets."""
...
def main():
    ...
    p.add_argument("--lod-dir", default="outputs/street_furniture/lods")
    ...
    for k in hero:
        ...
        bpy.ops.mesh.primitive_plane_add(size=1.2, location=(0, 0, 1.2))
