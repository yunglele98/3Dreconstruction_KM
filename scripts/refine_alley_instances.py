#!/usr/bin/env python3
"""Refine alley instances with deterministic yaw/scale and HERO routing."""
...
IN_CSV = DIR / "alley_instances_unreal_resolved_cm.csv"
OUT_CSV = DIR / "alley_instances_unreal_refined_cm.csv"
HERO_TXT = DIR / "hero_alley_types.txt"
SUMMARY = DIR / "alley_improvement_summary.json"
QA = DIR / "alley_placement_qa.md"
...
def main() -> int:
    ...
    counts = Counter(r["alley_key"] for r in rows)
    ...
    for r in rows:
        ...
        if r["alley_key"] in hero:
            r["asset_path"] = f"/Game/Street/Alleys/SM_{r['alley_key']}_HERO"
            r["lod_profile"] = "HERO"
        else:
