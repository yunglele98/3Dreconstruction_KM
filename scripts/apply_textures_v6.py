...
Version 6: Expanded support for urban elements (garages, poles, fences).

Run from Blender:
blender --background <input.blend> --python scripts/apply_textures_v6.py -- --output-blend <out.blend>
"""
...
MATERIAL_GROUPS = {
    "facade": {
        "patterns": ["mat_brick", "mat_facade", "mat_stone", "mat_lintel", "mat_quoins", "mat_foundation"],
        "folders": ["Toronto Fire Station 315", "brick", "concrete", "Oxford St", "Bellevue Ave"],
        "scale": 0.05
    },
    "garage": {
        "patterns": ["mat_door_garage", "mat_garage"], # Placeholder patterns
        "folders": ["Garages with graffiti, alley", "Keith Haring mural garage", "Parking garage exterior", "Portugal Auto Garage"],
        "scale": 0.1
    },
    "pole": {
        "patterns": ["mat_sidewalk_pole", "mat_custom_pole", "mat_sidewalk_light", "mat_door_knob"],
        "folders": ["Detail _ Reference", "Utility box full view with posters"],
        "scale": 0.2
    },
    "fence": {
        "patterns": ["mat_fence_picket", "mat_custom_fence"],
